...
<section class="inner-page-sec-padding-bottom space-db--30">
	<div class="container bg-light">
		<div class="row space-db-lg--60 space-db--30">
			...
			$id_author=mysqli_real_escape_string($connection,$_GET['id']);
			$query = "SELECT id,author_id,publish_house_id,category_id,name_book,release_year,release_number from books where author_id=$id_author ";
