        ...
        if(mysqli_num_rows($result)>0){      
         ...
         <div id="myCard" class="col-lg-4 col-md-6 mb-lg--60 mb--30">
           <div class="blog-card card-style-grid">
            ...
            <div >
             <h3 class="title"><a href="" ></a><?php echo$row['name_book']?></h3>
             <p class="post-meta"><span><?php echo $row['release_year']?></span> | 
              <a href="nav_select_author.php?id=<?php echo$row_author['id']; ?>">
                <?php echo $row_author['authorName']?></a>
              ...
              <article>
                ...
                <h5><a href="details_book.php?id=<?php echo$row['id'];?>" class="blog-link">المزيد</a></h5>
              </article>
            </div>
    ...
    <footer class="site-footer">
      <div class="footer-bottom">
        <div class="container">
          ...
          <p class="copyright-text">Copyright © 2020 <a href="https://github.com/HarounTaHa/php-course-final-project" class="author">HarouTaHa</a>. All Right Reserved. <br></p>
        </div>
      </div>
    </footer>
