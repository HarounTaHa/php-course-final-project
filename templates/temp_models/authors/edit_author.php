...
include('../../../database/databaseConnection.php');
	...
	if(isset($_GET['id'])){
		...
		$query="SELECT authorName from authors where id=$id";
...
<div class="content-wrapper">
    ...
    <?php
      ...
      if($_SERVER['REQUEST_METHOD']=='POST'){
      	...
      	if(!empty($id) && !empty($name_author)){
		
		 $query_edit = "UPDATE authors set authorName= '$name_author' where id =$id";
		 ...
		 if($result_edit){
        	  ...
        	  echo '<div class="card-header">
              	  <h3 class="card-title">canot edit author</h3>
          			  </div>';
              }
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input name="name-author" id="name" type="text" class="form-control"
                                value="<?= ((isset($row)) ? $row['authorName'] : "") ?>" 
                                >
                            </div>
                        </div>
                    </div>
