    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../publish_houses/show_publish_houses.php" class="nav-link">
                  <i class="fas fa-table nav-icon"></i>
                  <p>عرض</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../publish_houses/add_publish_house.php" class="nav-link">
                  <i class="fas fa-plus nav-icon"></i>
                  <p>اضافة</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="show_categorys.php" class="nav-link">
                  <i class="fas fa-table nav-icon"></i>
                  <p>عرض</p>
                </a>
              </li>
